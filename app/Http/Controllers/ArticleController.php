...
class ArticleController extends Controller
{
    ...
    public function index()
    {
        ...
        $url = config('qiita.url') . '/api/v2/tags/' . $tag_id . '/items?' . 'page=1&' . 'per_page=' . $per_page;
        ...
        $url = config('qiita.url') .
            '/api/v2/authenticated_user/items?per_page=' . $per_page;
    ...
    public function store(Request $request)
    {
        ...
        $message = new
            \Illuminate\Support\HtmlString('記事の投稿に成功しました');
    ...
    public function update(Request $request, $id)
    {
        ...
        $message = new
            \Illuminate\Support\HtmlString('記事の更新に成功しました');
        return redirect()->route('articles.index')
            ->with('flash_message', $message);
    }
